...
begin
  ...
  for t := Index to High(FItems) - ACount do begin
    FItems[t] := FItems[t + ACount];
  end;
...
begin
  if FParent<>nil then begin
     ...
     for t := Index to High(FParent.FItems) - 1 do begin
       FParent.FItems[t] := FParent.FItems[t + 1];
     end;
     SetLength(FParent.FItems, Length(FParent.FItems) - 1);
  end;
end;
